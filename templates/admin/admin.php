		...
		case 'admin': // Is admin the requested page?
			switch(defined('admin')){ // Is admin logged in?
				case TRUE: // If Admin is logged in, do this
					...
					foreach($old_config_files as $config_filename){
						unlink($config_filename);
					} // Deletes old config files
					...
					switch($n3u_inputVars['page']){
						...
						case 'blocks':
							...
							foreach($n3u_BlockList as $n3u_BlockListName => $n3u_BlockListArray){
								...
								if($n3u_BlockListArray['SortOrder'] == '0'){
									echo "\t\t\t\t\t\t\t\t\t\t\t" . '<option selected value="0">0</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t\t\t" . '<option value="0">0</option>' . PHP_EOL;
								}
								if($n3u_BlockListArray['SortOrder'] == '1'){
									echo "\t\t\t\t\t\t\t\t\t\t\t" . '<option selected value="1">1</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t\t\t" . '<option value="1">1</option>' . PHP_EOL;
								}
								if($n3u_BlockListArray['SortOrder'] == '2'){
									echo "\t\t\t\t\t\t\t\t\t\t\t" . '<option selected value="2">2</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t\t\t" . '<option value="2">2</option>' . PHP_EOL;
								}
								if($n3u_BlockListArray['SortOrder'] == '3'){
									echo "\t\t\t\t\t\t\t\t\t\t\t" . '<option selected value="3">3</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t\t\t" . '<option value="3">3</option>' . PHP_EOL;
								}
								if($n3u_BlockListArray['SortOrder'] == '4'){
									echo "\t\t\t\t\t\t\t\t\t\t\t" . '<option selected value="4">4</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t\t\t" . '<option value="4">4</option>' . PHP_EOL;
								}
								if($n3u_BlockListArray['SortOrder'] == '5'){
									echo "\t\t\t\t\t\t\t\t\t\t\t" . '<option selected value="5">5</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t\t\t" . '<option value="5">5</option>' . PHP_EOL;
								}
								if($n3u_BlockListArray['SortOrder'] == '6'){
									echo "\t\t\t\t\t\t\t\t\t\t\t" . '<option selected value="6">6</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t\t\t" . '<option value="6">6</option>' . PHP_EOL;
								}
								if($n3u_BlockListArray['SortOrder'] == '7'){
									echo "\t\t\t\t\t\t\t\t\t\t\t" . '<option selected value="7">7</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t\t\t" . '<option value="7">7</option>' . PHP_EOL;
								}
								if($n3u_BlockListArray['SortOrder'] == '8'){
									echo "\t\t\t\t\t\t\t\t\t\t\t" . '<option selected value="8">8</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t\t\t" . '<option value="8">8</option>' . PHP_EOL;
								}
								if($n3u_BlockListArray['SortOrder'] == '9'){
									echo "\t\t\t\t\t\t\t\t\t\t\t" . '<option selected value="9">9</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t\t\t" . '<option value="9">9</option>' . PHP_EOL;
								}
								echo "\t\t\t\t\t\t\t\t\t" . '</select>' . PHP_EOL
								. "\t\t\t\t\t\t\t\t" . '</span>' . PHP_EOL
								...
								if($n3u_BlockListArray['Position'] == 'Disabled'){
									echo "\t\t\t\t\t\t\t\t\t\t\t" . '<option selected value="#disabled">' . $n3u_lang['Disabled'] . '</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t\t\t" . '<option value="#disabled">' . $n3u_lang['Disabled'] . '</option>' . PHP_EOL;
								}
								if($n3u_BlockListArray['Position'] == 'header'){
									echo "\t\t\t\t\t\t\t\t\t\t\t" . '<option selected value="header">' . $n3u_lang['Header'] . '</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t\t\t" . '<option value="header">' . $n3u_lang['Header'] . '</option>' . PHP_EOL;
								}
								if($n3u_BlockListArray['Position'] == 'left'){
									echo "\t\t\t\t\t\t\t\t\t\t\t" . '<option selected value="left">' . $n3u_lang['Left'] . '</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t\t\t" . '<option value="left">' . $n3u_lang['Left'] . '</option>' . PHP_EOL;
								}
								if($n3u_BlockListArray['Position'] == 'right'){
									echo "\t\t\t\t\t\t\t\t\t\t\t" . '<option selected value="right">' . $n3u_lang['Right'] . '</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t\t\t" . '<option value="right">' . $n3u_lang['Right'] . '</option>' . PHP_EOL;
								}
								if($n3u_BlockListArray['Position'] == 'footer'){
									echo "\t\t\t\t\t\t\t\t\t\t\t" . '<option selected value="footer">' . $n3u_lang['Footer'] . '</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t\t\t" . '<option value="footer">' . $n3u_lang['Footer'] . '</option>' . PHP_EOL;
								}
								echo "\t\t\t\t\t\t\t\t\t" . '</select>' . PHP_EOL
								. "\t\t\t\t\t\t\t\t" . '</span>' . PHP_EOL
								. "\t\t\t\t\t\t\t" . '</span>' . PHP_EOL;
...
//							unset($DirectoryPaths,$DirectoryNames,$DirectorySizes,$i); // Cleanup (no longer needed)
						...
						case 'dashboard':
							...
							#	. "\t\t\t\t\t\t\t\t";n3u_FetchFeed('http://n3u.com/feed/');echo PHP_EOL // DISCONTINUED
							. "\t\t\t\t\t\t\t" . '</div>' . PHP_EOL
							. "\t\t\t\t\t\t\t" . '<div style="clear:right;display:block;float:right;margin:auto;width:45%;">' . PHP_EOL
							. "\t\t\t\t\t\t\t\t" . '<h5>' . $n3u_lang['Prosperent_News'] . '</h5>' . PHP_EOL
							. "\t\t\t\t\t\t\t\t";
							n3u_FetchFeed('http://community.prosperent.com/external.php?type=RSS2&forumids=2');
							echo PHP_EOL
							. "\t\t\t\t\t\t\t" . '</div>' . PHP_EOL
							. "\t\t\t\t\t\t" . '</div>' . PHP_EOL
							. "\t\t\t\t\t" . '</div>' . PHP_EOL
						...
						case 'main': // Is main the requested subpage?
							...
							if($n3u_configVars['Prosperent_Endpoint'] == 'CA'){
								echo "\t\t\t\t\t\t\t\t" . '<option selected value="CA">' . $n3u_lang['Country_CA'] . '</option>' . PHP_EOL;
							}else{
								echo "\t\t\t\t\t\t\t\t" . '<option value="CA">' . $n3u_lang['Country_CA'] . '</option>' . PHP_EOL;
							}
							if($n3u_configVars['Prosperent_Endpoint'] == 'UK'){
								echo "\t\t\t\t\t\t\t\t" . '<option selected value="UK">' . $n3u_lang['Country_UK'] . '</option>' . PHP_EOL;
							}else{
								echo "\t\t\t\t\t\t\t\t" . '<option value="UK">' . $n3u_lang['Country_UK'] . '</option>' . PHP_EOL;
							}
							if($n3u_configVars['Prosperent_Endpoint'] == 'USA'){
								echo "\t\t\t\t\t\t\t\t" . '<option selected value="USA">' . $n3u_lang['Country_USA'] . '</option>' . PHP_EOL;
							}else{
								echo "\t\t\t\t\t\t\t\t" . '<option value="USA">' . $n3u_lang['Country_USA'] . '</option>' . PHP_EOL;
							}
							echo "\t\t\t\t\t\t" . '</select>' . PHP_EOL
							...
							if($n3u_configVars['img_size'] == '75x75'){
								echo "\t\t\t\t\t\t\t\t" . '<option selected value="75x75">75x75</option>' . PHP_EOL;
							}else{
								echo "\t\t\t\t\t\t\t\t" . '<option value="75x75">75x75</option>' . PHP_EOL;
							}
							if($n3u_configVars['img_size'] == '125x125'){
								echo "\t\t\t\t\t\t\t\t" . '<option selected value="125x125">125x125</option>' . PHP_EOL;
							}else{
								echo "\t\t\t\t\t\t\t\t" . '<option value="125x125">125x125</option>' . PHP_EOL;
							}
							if($n3u_configVars['img_size'] == '250x250'){
								echo "\t\t\t\t\t\t\t\t" . '<option selected value="250x250">250x250</option>' . PHP_EOL;
							}else{
								echo "\t\t\t\t\t\t\t\t" . '<option value="250x250">250x250</option>' . PHP_EOL;
							}
							echo "\t\t\t\t\t\t" . '</select>' . PHP_EOL
						...
						case 'messages':
							...
							if(isset($temp_url) && $temp_url != NULL){
								...
								if(is_array($n3u_Messages)){
									...
									if(!filter_var($n3u_Messages['Email'], FILTER_VALIDATE_EMAIL)){
										$n3u_Messages['Email']='Email was not valid.';
									} // Verify Email
									echo "\t\t\t\t" . '<div id="Admin">' . PHP_EOL
									. "\t\t\t\t\t" . '<h3>' . ucfirst($n3u_inputVars['page']) . ' - ' . $n3u_lang['Administration'] . '</h3>' . PHP_EOL
									. "\t\t\t\t\t" . '<hr />' . PHP_EOL
						...
						case 'stats':
							...
							if(isset($n3u_configVars['accessKey']) && $n3u_configVars['accessKey'] != NULL){
								...
								if($referral_sales != NULL){
									krsort($referral_sales);
								}
						...
						case 'support':
							...
							if(isset($n3u_configVars['Supporter']) && $n3u_configVars['Supporter'] != NULL){
								...
								if($n3u_configVars['Supporter'] == '3'){
									echo "\t\t\t\t\t\t\t" . '<option selected value="3">1 out of 3 (' . number_format(1 / 3 * 100, 2) . '%)</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t" . '<option value="3">1 out of 3 (' . number_format(1 / 3 * 100, 3) . '%)</option>' . PHP_EOL;
								}
								if($n3u_configVars['Supporter'] == '4'){
									echo "\t\t\t\t\t\t\t" . '<option selected value="4">1 out of 4 (' . number_format(1 / 4 * 100, 2) . '%)</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t" . '<option value="4">1 out of 4 (' . number_format(1 / 4 * 100, 2) . '%)</option>' . PHP_EOL;
								}
								if($n3u_configVars['Supporter'] == '5'){
									echo "\t\t\t\t\t\t\t" . '<option selected value="5">1 out of 5 (' . number_format(1 / 5 * 100, 2) . '%)</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t" . '<option value="5">1 out of 5 (' . number_format(1 / 5 * 100, 2) . '%)</option>' . PHP_EOL;
								}
								if($n3u_configVars['Supporter'] == '8'){
									echo "\t\t\t\t\t\t\t" . '<option selected value="8">1 out of 8 (' . number_format(1 / 8 * 100, 2) . '%)</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t" . '<option value="8">1 out of 8 (' . number_format(1 / 8 * 100, 2) . '%)</option>' . PHP_EOL;
								}
								if($n3u_configVars['Supporter'] == '10'){
									echo "\t\t\t\t\t\t\t" . '<option selected value="10">1 out of 10 (' . number_format(1 / 10 * 100, 2) . '%)</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t" . '<option value="10">1 out of 10 (' . number_format(1 / 10 * 100, 2) . '%)</option>' . PHP_EOL;
								}
								if($n3u_configVars['Supporter'] == '15'){
									echo "\t\t\t\t\t\t\t" . '<option selected value="20">1 out of 15 (' . number_format(1 / 15 * 100, 2) . '%)</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t" . '<option value="15">1 out of 15 (' . number_format(1 / 15 * 100, 2) . '%)</option>' . PHP_EOL;
								}
								if($n3u_configVars['Supporter'] == '20'){
									echo "\t\t\t\t\t\t\t" . '<option selected value="20">1 out of 20 (' . number_format(1 / 20 * 100, 2) . '%)</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t" . '<option value="20">1 out of 20 (' . number_format(1 / 20 * 100, 2) . '%)</option>' . PHP_EOL;
								}
								if($n3u_configVars['Supporter'] == '25'){
									echo "\t\t\t\t\t\t\t" . '<option selected value="25">1 out of 25 (' . number_format(1 / 25 * 100, 2) . '%)</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t" . '<option value="25">1 out of 25 (' . number_format(1 / 25 * 100, 2) . '%)</option>' . PHP_EOL;
								}
								if($n3u_configVars['Supporter'] == '33'){
									echo "\t\t\t\t\t\t\t" . '<option selected value="33">1 out of 33 (' . number_format(1 / 33 * 100, 2) . '%)</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t" . '<option value="33">1 out of 33 (' . number_format(1 / 33 * 100, 2) . '%)</option>' . PHP_EOL;
								}
								if($n3u_configVars['Supporter'] == '0'){
									echo "\t\t\t\t\t\t\t" . '<option selected value="0">Off :(</option>' . PHP_EOL;
								}else{
									echo "\t\t\t\t\t\t\t\t" . '<option value="0">Off :(</option>' . PHP_EOL;
								}
