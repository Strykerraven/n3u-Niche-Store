<?php 
	...
	**/
	...
	if(isset($n3u_inputVars['querySuggestion']) && ($n3u_inputVars['querySuggestion'] != NULL)){
		echo "\t\t\t\t\t\t\t\t" . $n3u_lang['querySuggested'] . ' <a class="link" href="' . $n3u_configVars['self'] . '?x=search&amp;b=' . @$n3u_inputVars['b'] . '&amp;m=' . @$n3u_inputVars['m'] . '&amp;q=' . @$n3u_inputVars['q'] . '&amp;sort=' . @$n3u_inputVars['sort'] .'&amp;p=' . $n3u_inputVars['p'] . '" id="querySuggestion" title="' . $n3u_lang['querySuggested'] . ' ' . @$n3u_inputVars['q'] . '">' . @$n3u_inputVars['q'] . '</a>?' . PHP_EOL;
	}					
