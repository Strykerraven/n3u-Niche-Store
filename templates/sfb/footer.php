	...
	**/
	...
	switch($n3u_inputVars['x']){ // Is mode defined?
		...
		case "terms": // If terms, do below
			...
			if(defined('admin')){
				echo "\t\t\t\t\t" . '<a href="index.php?x=admin" id="Admin_Link" target="_self" title="' . $n3u_lang['Admin_Panel'] . '" type="text/html">' . $n3u_lang['Admin_Panel'] . '</a>' . PHP_EOL;
			}
			if($n3u_configVars['CleanUrls'] == TRUE){
				echo "\t\t\t\t\t" . '<ul>' . PHP_EOL
				. "\t\t\t\t\t\t" . '<li>&nbsp;<span class="bullet">&bull;</span>&nbsp;<a href="./" id="ViewHome" target="_self" title="' . n3u_TitleCleaner($n3u_lang['Home']) . '" type="text/html">' . $n3u_lang['Home'] . '</a></li>' . PHP_EOL
				. "\t\t\t\t\t\t" . '<li>&nbsp;<span class="bullet">&bull;</span>&nbsp;<a href="./go/'. base64_encode(urlencode('http://prosperent.com/policies/ftc')).'.htm" id="Disclosure" target="_blank" title="' . n3u_TitleCleaner($n3u_lang['Disclosure']) . '" type="text/html">' . $n3u_lang['Disclosure'] . '</a></li>' . PHP_EOL
				. "\t\t\t\t\t\t" . '<li>&nbsp;<span class="bullet">&bull;</span>&nbsp;<a href="./privacy.htm" id="PrivacyPolicy" target="_self" title="' . n3u_TitleCleaner($n3u_lang['PrivacyPolicy']) . '" type="text/html">' . $n3u_lang['PrivacyPolicy'] . '</a></li>' . PHP_EOL
				. "\t\t\t\t\t\t" . '<li>&nbsp;<span class="bullet">&bull;</span>&nbsp;<a href="./terms.htm" id="TermsConditions" target="_self" title="' . n3u_TitleCleaner($n3u_lang['TermsConditions']) . '" type="text/html">' . $n3u_lang['TermsConditions'] . '</a></li>' . PHP_EOL
				. "\t\t\t\t\t\t" . '<li>&nbsp;<span class="bullet">&bull;</span>&nbsp;<a href="./contact.htm" id="Contact' . n3u_IdCleaner($n3u_configVars['SiteName']) . '" target="_self" title="' . n3u_TitleCleaner($n3u_lang['Contact']) . '" type="text/html">' . $n3u_lang['Contact'] . '</a></li>' . PHP_EOL
				. "\t\t\t\t\t" . '</ul><br />' . PHP_EOL;
			}else{
				echo "\t\t\t\t\t" . '<ul>' . PHP_EOL
				. "\t\t\t\t\t\t" . '<li>&nbsp;<span class="bullet">&bull;</span>&nbsp;<a href="./" id="ViewHome" target="_self" title="' . n3u_TitleCleaner($n3u_lang['Home']) . '" type="text/html">' . $n3u_lang['Home'] . '</a></li>' . PHP_EOL
			...
			if(isset($n3u_configVars['Supporter']) && $n3u_configVars['Supporter'] == '0'){echo '&nbsp;Powered by <a href="http://n3u.com" id="n3uPoweredBy" target="_blank" title="Powered by n3u Niche Store">n3u Niche Store</a><br />' . PHP_EOL;}else{echo '<br />' . PHP_EOL;}
